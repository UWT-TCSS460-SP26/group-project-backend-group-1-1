    ...
    <section className="mx-auto max-w-3xl border border-zinc-800 bg-zinc-950 p-10 shadow-2xl">
      <div className="mb-10 border-b border-zinc-800 pb-8">
        ...
        <p className="mt-5 max-w-xl text-lg leading-8 text-zinc-400">
          Found an issue with our API or website? Fill out the form below
          and our team will review it as soon as possible.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(event) =>
              updateField('stepsToReproduce', event.target.value)
            }
